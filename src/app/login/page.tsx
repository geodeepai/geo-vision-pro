            ...
            {submitted ? (
              ...
              <>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 hover:shadow-sm transition-all font-semibold text-sm text-slate-700 mb-6"
                >
                  {/* Google logo SVG */}
