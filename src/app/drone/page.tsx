...
export default function DronePage() {
  return (
    <div className="min-h-screen bg-white">
      <SubpageHero
        crumbs={[{ label: "Services", href: "/#services" }, { label: "Drone & UAV Mapping" }]}
        badge="UAV Survey Services"
        title="Drone & UAV Mapping"
        highlight="Mapping"
        desc="Survey-grade UAV mapping services delivering centimetre-accurate orthomosaics, DEMs, point clouds, and volumetric reports for construction, mining, agriculture, and infrastructure inspection."
        accent={COLOR}
        stats={[{ val: "300+", label: "UAV Surveys" }, { val: "2 cm", label: "Min GSD Accuracy" }, { val: "5 Days", label: "Avg Turnaround" }, { val: "6+", label: "Sectors Served" }]}
        ...
        <section>
          <div className="relative overflow-hidden rounded-2xl p-8 text-center border" style={{ background: `${COLOR}08`, borderColor: `${COLOR}25` }}>
            <div className="relative z-10">
              <h2 className="text-2xl font-black text-slate-900 mb-3">Ready to Survey from the Air?</h2>
              <p className="text-slate-500 text-sm max-w-lg mx-auto mb-7">Share your site location, coverage area, and accuracy requirements — we'll deliver centimetre-precise UAV products on schedule.</p>
